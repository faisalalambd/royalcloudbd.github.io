                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                ...
                                <input name="c_name" value="" id="input-firstname" type="text" >
                            </div>
							...
							<div class="form-group col-md-12 col-lg-12 col-xl-12">
                                ...
                                <input name="c_mail" value="" id="input-email" type="email" >
                            </div>

                            <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                <label for="input-telephone">Telephone <span class="required-f">*</span></label>
                                <input name="c_phone" value="" id="input-telephone" type="tel">
                            </div>

                            <div class="form-group col-md-12 col-lg-12 col-xl-12">
                                <label for="input-company">Address<span class="required-f">*</span></label>
                                <textarea class="form-control resize-both" rows="3" name="c_address" value=""></textarea>
                            </div>
