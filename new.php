...
<div class="section-header text-center" style="margin: 5rem 0; font-size: 24px; text-transform: capitalize;">
    <h2 class="h2 heading-font">New Arrivals</h2>
</div>
<!--End Title-->
            ...
            <div class="sidebar_tags">
                ...
                <div class="sidebar_widget filterBox filter-widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <input type="checkbox" value="allen-vela" id="check1">
                            <label for="check1"><span><span></span></span>All Box Mods</label>
                        </li>

                        <li>
                            <input type="checkbox" value="oxymat" id="check3">
                            <label for="check3"><span><span></span></span>Temperature Control Mods</label>
                        </li>

                        <li>
                            <input type="checkbox" value="vanelas" id="check4">
                            <label for="check4"><span><span></span></span>DNA Chip Box Mods</label>
                        </li>

                        <li>
                            <input type="checkbox" value="pagini" id="check5">
                            <label for="check5"><span><span></span></span>High-End Mods</label>
                        </li>

                        <li>
                            <input type="checkbox" value="monark" id="check6">
                            <label for="check6"><span><span></span></span>Built-In Battery Mods</label>
                        </li>
                ...
                <div class="sidebar_widget filterBox filter-widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <input type="checkbox" value="allen-vela" id="check1">
                            <label for="check1"><span><span></span></span>RDA (Rebuildable Dripper
                                Atomizers)</label>
                        </li>

                        <li>
                            <input type="checkbox" value="oxymat" id="check3">
                            <label for="check3"><span><span></span></span>RTA (Rebuildable Tank Atomizer)</label>
                        </li>

                        <li>
                            <input type="checkbox" value="vanelas" id="check4">
                            <label for="check4"><span><span></span></span>RDTA (Rebuildable Dripping Tank
                                Atomizers)</label>
                        </li>

                        <li>
                            <input type="checkbox" value="pagini" id="check5">
                            <label for="check5"><span><span></span></span>Postless Deck</label>
                        </li>

                        <li>
                            <input type="checkbox" value="monark" id="check6">
                            <label for="check6"><span><span></span></span>Two-Post Deck</label>
                        </li>

                    </ul>

                </div>
                <!--End Rebuildables Type-->
                ...
                <div class="sidebar_widget filterBox filter-widget">
                    ...
                    <ul>
                        ...
                        <li>
                            <input type="checkbox" value="allen-vela" id="check1">
                            <label for="check1"><span><span></span></span>Replacement Pods</label>
                        </li>
